...
public class FeatureMovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        mSocket.connect();
        mSocket.emit("getFeatureMovie");
        mSocket.on("listFeatureMovie", getData);

        myView = inflater.inflate(R.layout.fragment_feature_movie, container, false);
